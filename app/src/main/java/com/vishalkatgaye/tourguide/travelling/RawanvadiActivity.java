package com.vishalkatgaye.tourguide.travelling;
...
public class RawanvadiActivity extends AppCompatActivity {

    private ImageView mBackground_Image;
    private TextView mPlace_Information;
    private TextView mPlace_Title;
    private FrameLayout mTiming;
    private ImageButton mMailButton;
    private Uri mImageUri;

    /* It will navigate to previous fragment by selecting back button from status bar*/
    @Override
...
//        Share the contents of this activity.
        ...
        mMailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mImageUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.rawanvadi);
                Intent shareIntent = new Intent(Intent.ACTION_SENDTO);
                shareIntent.setType("image/png");
                shareIntent.setData(Uri.parse("mailto:"));
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.rawanvadi));
                shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.rawanvadi_info));
