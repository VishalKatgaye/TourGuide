...
public class KambhojActivity extends AppCompatActivity {
...
//        Share the contents of this activity.
        ...
        mMailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mImageUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.kambhoj_foods);
                Intent shareIntent = new Intent(Intent.ACTION_SENDTO);
                shareIntent.setType("image/png");
                shareIntent.setData(Uri.parse("mailto:"));
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.kambhoj));
                shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.kambhoj_info));
