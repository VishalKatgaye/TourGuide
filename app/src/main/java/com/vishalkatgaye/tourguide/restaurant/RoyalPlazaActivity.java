...
public class RoyalPlazaActivity extends AppCompatActivity {
...
//      Share the contents of this activity.
        ...
        mMailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mImageUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.hotel_royal_plaza);
                Intent shareIntent = new Intent(Intent.ACTION_SENDTO);
                shareIntent.setType("image/png");
                shareIntent.setData(Uri.parse("mailto:"));
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.royal_plaza));
                shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.royal_plaza_info));
