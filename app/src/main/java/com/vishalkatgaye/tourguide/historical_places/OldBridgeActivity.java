package com.vishalkatgaye.tourguide.historical_places;
...
public class OldBridgeActivity extends AppCompatActivity {
...
//        Share the contents of this activity.
        ...
        mMailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mImageUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.old_bridge);
                Intent shareIntent = new Intent(Intent.ACTION_SENDTO);
                shareIntent.setType("image/png");
                shareIntent.setData(Uri.parse("mailto:"));
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.bhandara_old_bridge));
                shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.bhandara_old_bridge_info));
