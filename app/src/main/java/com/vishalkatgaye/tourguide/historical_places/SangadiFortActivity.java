...
public class SangadiFortActivity extends AppCompatActivity {
...
//        Share the contents of this activity.
        ...
        mMailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mImageUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.sangadi_fort);
                Intent shareIntent = new Intent(Intent.ACTION_SENDTO);
                shareIntent.setType("image/png");
                shareIntent.setData(Uri.parse("mailto:"));
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.sangadi_fort));
                shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.sangadi_fort_info));
