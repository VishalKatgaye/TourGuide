...
public class SindhiLaneActivity extends AppCompatActivity {
...
//        Share the contents of this activity.
        ...
        mMailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mImageUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.sindhi_lane);
                Intent emailIntent = new Intent(Intent.ACTION_SENDTO);
                emailIntent.setType("image/png");
                emailIntent.setData(Uri.parse("mailto:"));
                emailIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.sindhi_lane));
                emailIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.sindhi_lane_info));
