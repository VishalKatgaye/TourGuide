package com.vishalkatgaye.tourguide.shopping;
...
public class GandhiChaukActivity extends AppCompatActivity {
...
//        Share the contents of this activity.
        ...
        mMailButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mImageUri = Uri.parse("android.resource://" + getPackageName() + "/" + R.drawable.gandhi_chauk);
                Intent shareIntent = new Intent(Intent.ACTION_SENDTO);
                shareIntent.setData(Uri.parse("mailto:"));
                shareIntent.putExtra(Intent.EXTRA_SUBJECT, getString(R.string.gandhi_chauk));
                shareIntent.putExtra(Intent.EXTRA_TEXT, getString(R.string.gandhi_chauk_info));
